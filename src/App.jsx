                ...
                return (
                  <div style={{
                    ...
                    <div style={{ flexGrow: 1, minWidth: 0 }}>
                      ...
                      {activeSettingsTab !== "import_export" && activeSettingsTab !== "task_engine" && activeSettingsTab !== "diagnostics" && activeSettingsTab !== "github_deployment" && activeSettingsTab !== "website_content_activity" && activeSettingsTab !== "external_link_library" && activeSettingsTab !== "global_restore_points" && activeSettingsTab !== "platforms_services" && (
                        <div style={{
                          backgroundColor: '#070b13',
                          border: '1px solid rgba(255, 255, 255, 0.06)',
                          borderRadius: '12px',
